...
It was the scary PR of the batch. I shipped it in the middle of an afternoon where Claude and I pushed thirteen PRs to production, and I wrote about that day [separately](https://marcobellingeri.dev/en/writing/thirteen-prs-one-afternoon). Twelve of those PRs were routine. This one deleted a safety net and replaced it with a promise from an API, in the same diff.
