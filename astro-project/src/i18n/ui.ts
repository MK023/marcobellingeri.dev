...
export const ui = {
  en: {
    ...
    'site.description':
      'Marco Bellingeri — freelance Cloud Platform & AI Security Engineer. Hands-on AI, Cloud and Security: pair programming, real case studies, automation. Casale Monferrato, Piemonte, Italy.',
    'og.locale': 'en_US',
  ...
  it: {
    'site.title': 'Bellingeri — AI, Cloud & Security Edition',
    'site.description':
      'Marco Bellingeri — Cloud Platform & AI Security Engineer freelance. AI, Cloud e Security con un approccio hands-on: pair programming, case study reali, automazione. Casale Monferrato, Piemonte.',
    'og.locale': 'it_IT',
