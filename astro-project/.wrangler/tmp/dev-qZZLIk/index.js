...
// worker/index.js
function scegliLingua(paese, cookie = null) {
...
__name(scegliLingua, "scegliLingua");
var rispostaJson = /* @__PURE__ */ __name((obj, status = 200) => new Response(JSON.stringify(obj), { status, headers: { "Content-Type": "application/json" } }), "rispostaJson");
async function gestisciContatto(request, env) {
  ...
  try {
    ...
    return rispostaJson({ error: "body" }, 400);
  }
  ...
  const brief = String(dati.brief ?? "").trim().slice(0, 4e3);
...
__name(gestisciContatto, "gestisciContatto");
var worker_default = {
  /**
...
// .wrangler/tmp/bundle-SgQ42P/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-SgQ42P/middleware-loader.entry.ts
